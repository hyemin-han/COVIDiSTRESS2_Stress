...
items.PSUP <- c('primary_stressors_1','primary_stressors_2',
                'primary_stressors_3','primary_stressors_4')
cfa.model.PSUP <-'RES =~ primary_stressors_1 + primary_stressors_2+
  primary_stressors_3+  primary_stressors_4'
...
simulation_CLE <- function(times,n,data,n.include,seed=1){
  ...
  for (j in 1:times){
    ...
    cfa.model.PSUP <-'PSUP =~ primary_stressors_1 + 
primary_stressors_2 + primary_stressors_3 +primary_stressors_4'
