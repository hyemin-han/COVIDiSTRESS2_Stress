...
items.PSUP <- c('identity_1_0neutral','identity_2_0neutral',
                'identity_3_0neutral','identity_4_0neutral')
cfa.model.PSUP <-'RES =~ identity_1_0neutral + identity_2_0neutral+
  identity_3_0neutral+identity_4_0neutral'
...
#Not good 0.10233495   0.03053738   0.96461385   0.89384156 
...
# mediocre  0.08075211   0.04720280   0.94609543   0.93389805 
...
# not good   0.12431377   0.08327842   0.79672113   0.84334472
...
simulation_CLE <- function(times,n,data,n.include,seed=1){
  ...
  for (j in 1:times){
    ...
    cfa.model.PSUP <-'PSUP =~ identity_1_0neutral + 
identity_2_0neutral + identity_3_0neutral +identity_4_0neutral'
